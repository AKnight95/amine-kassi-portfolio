...
export const metadata: Metadata = {
  title: "Contact — Amine Kassi",

  description:
    "Contacter Amine Kassi, développeur Full-Stack TypeScript / React / Node.js basé en Île-de-France.",
};


const email = "amine.k4595@gmail.com";

const github = "https://github.com/AKnight95";
